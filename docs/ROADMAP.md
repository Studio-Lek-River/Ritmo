...
- **Afgesplitst:** S12a (#153) voor de `returnTo` door de OAuth-state en week-in-één-klik; de overige oorspronkelijk genoemde verfijningen kregen bij het vaststellen van de S12a-scope elk een eigen issue: diff/PATCH i.p.v. delete+create (#154, KLAAR), de opruimknop "alle Ritmo-blokken" (#155), automatisch bijwerken (#156), twee-richtingsverkeer (#157, bouwt op #154), all-day en herhalingen (#158, geblokkeerd door het ontbrekende datamodel), en meerdere Outlook-accounts (#159).
