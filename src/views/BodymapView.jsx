...
// De buik is een 3x3 raster: drie rijen (boven/midden/onder) x drie kolommen
// (links/midden/rechts); de torso-rect hieronder is verbreed en verlengd zodat
// alle negen stippen erbinnen vallen.
const ZONE_DOTS = {
  abdomenUpperL: { cx: 80, cy: 82 },
  abdomenUpperM: { cx: 100, cy: 82 },
  abdomenUpperR: { cx: 120, cy: 82 },
  abdomenMidL: { cx: 80, cy: 112 },
  abdomenMidM: { cx: 100, cy: 112 },
  abdomenMidR: { cx: 120, cy: 112 },
  abdomenLowerL: { cx: 80, cy: 142 },
  abdomenLowerM: { cx: 100, cy: 142 },
  abdomenLowerR: { cx: 120, cy: 142 },
  armL: { cx: 52, cy: 92 },
  armR: { cx: 148, cy: 92 },
  thighL: { cx: 86, cy: 224 },
...
// De buik is een 3x3 raster (kolommen cx 80/100/120, rijen cy 82/112/142, 20px
// resp. 30px uit elkaar); de buikstippen en -ringen zijn daarom kleiner dan de
// arm/dij-stippen zodat de suggestie- en laatste-prik-ringen van naastliggende
// zones elkaar niet overlappen.
const ABDOMEN_DOT_RADIUS = 9;
const ABDOMEN_RING_RADIUS = 11;
const ABDOMEN_LAST_RING_RADIUS = 10;
