...
export default {
  ...
  household: {
    ...
    mealPlan: {
      ...
      sectionMetaNone: 'Nobody today',
      emptyTitle: 'Set up meal planning',
      emptyDescription: 'Track who eats at home each day. Add housemates to get a shared overview.',
      emptyCta: 'Set up',
      manageHousehold: 'Manage household',
      prevWeek: 'Previous week',
      nextWeek: 'Next week',
      eatingTotal: '{n} eating',
      eatingTotalNone: 'Nobody eating',
      defaultYes: 'default: eating',
      defaultNo: 'default: not eating',
      statusEat: 'Eating',
      statusSkip: 'Not eating',
      deadlinePassedAdmin: 'Deadline ({time}) has passed. As admin you can still edit.',
      deadlinePassedMember: 'Deadline ({time}) has passed. Only the admin can still edit.',
      addGuest: 'Add guest',
      guestNamePlaceholder: 'Guest name',
      removeGuestAria: 'Remove guest',
      confirmSkipTitle: 'Keep guests?',
      confirmSkipDescription: 'You have {n} guest(s) added. Do you want to remove them too?',
      confirmSkipRemove: 'Remove guests',
      confirmSkipKeep: 'Keep guests',
      settings: {
        title: 'Meal plan settings',
        householdNameLabel: 'Household name',
        householdNamePlaceholder: 'E.g. The Smith House',
        defaultStatusLabel: 'Default eating status',
        defaultStatusHelp: 'Applies to housemates who do not fill in anything.',
        defaultStatusYes: 'Yes by default',
        defaultStatusNo: 'No by default',
        deadlineEnabledLabel: 'Enable deadline',
        deadlineTimeLabel: 'Can edit until:',
        deadlineHelp: 'After this time only the admin can make changes.',
        membersLabel: 'Housemates',
        addMember: 'Add housemate',
        memberNamePlaceholder: 'Name',
        yourNamePlaceholder: 'Your name',
        removeMemberAria: 'Remove',
        removeMemberConfirmTitle: 'Remove housemate?',
        removeMemberConfirmDesc: '"{name}" will be removed from this household.',
        roleAdmin: 'Admin',
        roleMember: 'Member',
        youSuffix: '(you)',
        save: 'Save',
  ...
  bodymap: {
    zoneAbdomenL: 'Abdomen left',
    zoneAbdomenR: 'Abdomen right',
